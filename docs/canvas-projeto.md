...
| Integrantes | Visualização - Nilda<br>Modelagem - Rhayane<br>SM - Danilo<br>QA - Amanda<br>Dados - Cauê<br>PO/Analista - Renato<br>PO/Analista - Maysa<br>Pitch - Vitor |
...
| 2 | Quando elas acontecem: existe alguma sazonalidade ao longo dos meses ou uma concentração em horários específicos do dia? | Orienta a gestão de escala e dimensionamento. Informa decisões de planejamento de turnos, definição de sobreavisos, contratação temporária em períodos críticos (como épocas de chuva) e programação de manutenções preventivas para períodos de baixa demanda. | Sim |
...
Ocorrências de interrupção e queda de energia na área de atuação da Neoenergia Pernambuco, considerando um período histórico definido pela disponibilidade dos dados, com organização dos dados em banco/pipeline, identificação dos principais pontos críticos e padrões de ocorrência e dashboard para acompanhamento da distribuição, frequência e características das interrupções.
...
**Canal de comunicação da equipe (fora do horário de aula):** Grupo do WhatsApp + Trello

## Validação do mentor (preenchida pelo mentor no E2)

| Campo | Preenchimento |
| --- | --- |
| Status | ( ) Aprovado ( ) Aprovado com ajustes (X) Devolvido com pendências |
| Data | 16/09/2026 |
| Amostra baixada e aberta verificada? | (X) Sim ( ) Não |
| Pendências (com prazo até o E3 — seg 21/09) | Refinar escopo<br>Anotar riscos |
